...
* Qlik Product Download site

# Qlik Sense

Primarily focussed on Qlik Sense Enterprise for Windows, all versions in the current versioning schema.

| Qlik Software (Major)     | Qlik Software (Minor) | Version No (Build) | Release date (download site as sometimes re-releases due to bugs) | End of support         | Notes       |
|---------------------------|-----------------------|--------------------|-------------------------------------------------------------------|------------------------|-------------|
| Qlik Sense November 2019  | Patch 4               | 13.52.8            | 29/01/2020                                                        | As per initial release |             |
